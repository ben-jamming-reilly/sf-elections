  ...
  return (
    <Element
      ...
      className={clsx(
        ...
        variant === "primary" &&
          "bg-black text-white notouch:hover:bg-white notouch:hover:text-black notouch:disabled:hover:bg-black notouch:disabled:hover:text-white",
        variant === "secondary" &&
          "border-2 bg-white text-black notouch:hover:bg-black notouch:hover:text-white notouch:disabled:hover:bg-white notouch:disabled:hover:text-black",
